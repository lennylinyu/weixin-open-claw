...
import { MessageItem, MessageItemType, MessageState, MessageType, SendMessageReq } from "../types";
 ...
 */
export function createTextMessage(params: { to: string, text: string}): SendMessageReq {
 ...
 */
export function createFileMessage(params: { to: string, info:FileUploadInfo }):MessageItem {
    return {
        ...
        file_item:{
            media:{
                ...
                aes_key: Buffer.from(params.info.aeskey.toString("hex")).toString("base64"),
                encrypt_type: 1,
            },
 ...
 */
export function createImageMessage(params: { to: string, info:FileUploadInfo }):MessageItem {
    return {
 ...
 */
export function createVideoMessage(params: { to: string, info:FileUploadInfo }):MessageItem {
    return {
 ...
 */
export function sendMessage(params: { baseUrl:string, message: SendMessageReq, contextToken: string,}) {
